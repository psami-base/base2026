...
#include "point.hpp"    // check include guards
#include "segment.hpp"  // check include guards
#include "ray.hpp"      // check include guards
#include "line.hpp"     // check include guards
#include "circle.hpp"   // check include guards
#include "polygon.hpp"  // check include guards
